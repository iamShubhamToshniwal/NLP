...
Original file is located at
    https://colab.research.google.com/drive/1mkUzBSnvR8IAuvCTqXYYtXyupWncIoxb
"""
...
model = pickle.load(open('nlpshubham.pkl','rb'))   


def review(text):
  dataset = pd.read_csv('NLP.tsv')
...
if st.button("About"):
  st.subheader("Developed by Shubham Toshniwal")
